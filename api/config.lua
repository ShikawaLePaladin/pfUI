...
function pfUI:LoadConfig()
  ...
  pfUI:UpdateConfig("loot",       "council",     "enable",           "0")
  pfUI:UpdateConfig("loot",       "council",     "duration",         "15")
  pfUI:UpdateConfig("loot",       "council",     "autoclose",        "1")
  ...
  pfUI:UpdateConfig("thirdparty", "octometer",   "enable",           "1")
