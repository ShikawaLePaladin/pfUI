  ...
  do -- Generate Config UI
    CreateGUIEntry(T["About"], nil, function()
      ...
      github:SetScript("OnClick", function()
        pfUI.chat.urlcopy.CopyText("https://github.com/ShikawaLePaladin/pfUI")
      end)
      SkinButton(github)
    ...
    CreateGUIEntry(T["Nameplates"], nil, function()
      ...
      CreateConfig(U["nameplates"], T["Show Lootable Icon (SuperWoW 2.0)"], C.nameplates, "lootable", "checkbox", nil, nil, nil, nil, "vanilla")
